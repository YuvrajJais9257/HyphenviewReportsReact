...
import CardLayout from "./Components/StatusCardLayout/CardLayout";
  ...
  return (
    <div>
      <Routes>
        ...
        <Route
          path="/ReportSchedulerAddNewRtp"
          element={<ReportSchedulerAddNewRtp />}
        />
        <Route path="/GenerateReport" element={<GenerateReport />} />
        <Route path="/NewFeature" element={<NewFeature />} />
        <Route path="/ReportAsination" element={<ReportAsination />} />
        <Route
          path="/AssignationAndFeature"
          element={<AssignationAndFeature />}
        />
        ...
        />
        <Route
          path="/ReportSchedulerUpdate"
          element={<ReportSchedulerUpdate />}
        />
        ...
        <Route
          path="/SampleQueryForDrilldown"
          element={<SampleQueryForDrilldown />}
        />
        ...
        <Route
          ...
          element={<ListOfDashboardCanvas />}
        />
        <Route path="/StatusCardLayout" element={<CardLayout />} />
