...
function DashboardNew() {
    ...
    const [leftContainerWidth, setLeftContainerWidth] = useState('6%');
    const [rightContainerWidth, setRightContainerWidth] = useState('calc(100% - 7%)');
    ...
    const toggleSidebar = () => {
        if (isSidebarCollapsed) {
            ...
            setRightContainerWidth('80%');
        } else {
            setLeftContainerWidth('6%');
            setRightContainerWidth('93%');
        }
    ...
    return (
        <div className='Dashboard_container'>
            < div className='container_cnt'>
                ...
                <div className='left-sidebar' style={{ width: isSidebarCollapsed ? "6%" : "20%" }}>
