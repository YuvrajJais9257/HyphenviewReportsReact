...
function BoxForBooleanValue({
  ...
  useEffect(() => {
    if (PreviewchartData) {
      const dataStr = PreviewchartData.toLowerCase();
      if (
        dataStr === "up" ||
        dataStr === "yes" ||
        dataStr === "true" ||
      ...
      {PreviewchartData && (
        ...
        >
          ...
          <p
            ...
            style={{ fontSize: fontSizebox.font_size_title, fontWeight: "800" }}
          >
            {CustomeDetailOfReport.title}
          </p>
          <div
            className={styles.previewContent}
            style={{ fontSize: fontSizebox.font_size_value, fontWeight: "800" }}
          >
            {PreviewchartData}
          </div>
        </div>
...
export default BoxForBooleanValue;
