...
export default function AssignationAndFeature() {
    ...
    console.log(listofReportId,accessfeaturesss,"listofReportId")
    ...
    const handelresponjsonforfeature = (result,group_id,user) =>{
        ...
        console.log(featurelist,accessallowes,"accessallowes")
    ...
    const handleCheckboxselectedAll = (e, accessmask, feature) => {
        ...
        setlistofReportId((prev) => {
            ...
            if (featureIndex !== -1) {
                ...
                console.log(selestdfdsf,"selestdfdsf") 
  ...
  //   const[val,setval] = useState()
    ...
    //   useEffect(()=>{
    //     const initialState = listofallfeature && listofallfeature.map((item) => {
    //         const featureObj = {};
    ...
    //   const accessval = accessfeaturesss.forEach(({ featurename, accessmask }) => {
